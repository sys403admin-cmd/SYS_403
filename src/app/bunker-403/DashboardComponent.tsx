          ...
          <div className="space-y-12 lg:space-y-20 relative z-10">
            <header className="flex flex-col md:flex-row md:items-end justify-between gap-6">
              ...
              <button 
                ...
                className="px-6 py-3 border-2 border-urban-red text-urban-red font-black uppercase italic text-xs hover:bg-urban-red hover:text-white transition-all flex items-center gap-2 group"
              >
                <Trash2 size={16} className="group-hover:animate-bounce" /> PURGAR_TODO
              </button>
            </header>
